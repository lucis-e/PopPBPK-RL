...
out_map = 'Resultados/mapa_estados_train.txt' # output 1: .txt con las correspondencias de la codificacion de los vectores que definen los estados

# Para el estudio del rendimiento del modelo basado en la función de utilidad:
#out_exp = 'Resultados/experiencias_RU_train.csv' # output 2: .csv con las experiencias (trayectorias): (S_t, a, S_t+1, r) 

# Para el estudio del rendimiento del modelo basado en la función dependiente de la distancia euclidiana:
out_exp = 'Resultados/experiencias_RE_train.csv' # output 2: .csv con las experiencias (trayectorias): (S_t, a, S_t+1, r) 
